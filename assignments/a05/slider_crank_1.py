...
z2x = chrono.Q_from_AngY(chrono.CH_C_PI / 2)
  ...
  #### 180 degrees/s.
  #### -------------------------------------------------------------------------
speed_fun = chrono.ChFunction_Const()
speed_fun.Set_yconst(chrono.CH_C_PI)
ground_motor=chrono.ChLinkMotorRotationSpeed()
ground_motor.SetName("ground motor")
ground_motor.Initialize(ground, crank, chrono.ChFrameD(chrono.ChVectorD(0, 0, 0), z2y))
ground_motor.SetSpeedFunction(speed_fun)
system.AddLink(ground_motor)
...
while (application.GetDevice().run()):
    ...
    if system.GetChTime() > 0.05:
        ...
        motor_torque.append(ground_motor.GetMotorTorque())
